...
pub use compiler::{
    ModuleGraph, ModuleId, ModuleNode, ModulePackageIdentity, Program, build_module_graph,
    build_module_graph_with_module_identity_and_overrides, build_module_graph_with_overrides,
    check_module_source_text_with_module_identity_and_overrides, check_script_source_text,
    ...
    compile_source_text_to_c_with_module_identity, compile_source_text_to_c_with_project_modules,
    compile_source_to_c, compile_source_to_c_for_target, compile_source_to_c_with_external_imports,
    compile_source_to_c_with_module_identity_for_target,
    compile_source_to_c_with_project_modules_for_target, expected_module_package,
};

...
pub(super) fn emit_array_helpers(out: &mut String, element_type: &ValueType) {
    ...
    out.push(' ');
    out.push_str(&array);
    out.push_str("_from_values(size_t len, const ");
    out.push_str(&c_type(element_type));
    out.push_str(" *values) {\n");
    out.push_str("    ");
    out.push_str(&array);
    ...
    out.push_str(&array);
    out.push_str("_new();\n");
    out.push_str("    for (size_t i = 0; i < len; i += 1) { array = ");
    out.push_str(&array);
    out.push_str("_push(array, values[i]); }\n");
    out.push_str("    return array;\n");
    out.push_str("}\n\n");
    out.push_str("static ");
    out.push_str(&c_type(element_type));
    ...
    out.push_str("    if (index >= array.len) { nomo_panic(\"array index out of bounds\"); }\n");
    out.push_str("    return ");

...
- `async_http_contract`: P2-HTTP-A owner-affine suspend ABI example; it deterministically reports the secret-safe `runtime_unavailable` placeholder until the native reactor transport slice lands
